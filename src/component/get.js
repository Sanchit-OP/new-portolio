    ...
    return(
        <main className="h-screen p-40 pt-[7.5rem] pb-20">
            ...
            <div className="flex flex-row justify-center  py-10 pl-40">
                <a href="https://instagram.com/sanchit0701?igshid=ZDdkNTZiNTM=" className=" w-2/5 p-10"><img src={Insta} width={200} className="rounded-xl " /></a>
                <a href="https://www.linkedin.com/in/sanchit-ahlawat-5412931b5" className=" w-2/5 p-10"><img src={Linkd} width={200} className="rounded-[3rem]"/></a>
            </div>
